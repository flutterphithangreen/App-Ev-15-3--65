              ...
              if (!gMapCtrl.isLocationLoaded) {
                return Scaffold(
                  body: Container(
                    ...
                    //       valueColor:
                    //           AlwaysStoppedAnimation(_theme.primaryColor),
                    //     ),
                    //   ],
                    // ),
                  ),
                ...
                return Stack(
                  children: [
                    ...
                    gMapCtrl.showSearch ? SearchWidget() : SizedBox.shrink(),
                    MapFloatingButton(),
                  ],
                );
              }
            ...
            TypeAheadField(
              ...
              suggestionsCallback: (pattern) async {
                ...
                if (pattern != null && pattern.trim().length > 0) {
                  var googlePlace =
                      GooglePlace("AIzaSyB-dZldP4jXqVOZYpXbGYFkeYOJHSHpoiw");
                  var result = await googlePlace.autocomplete
                      .get(pattern, language: "th");
                  print("result = ${result}");
