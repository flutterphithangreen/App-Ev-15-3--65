...
class ChangeAvatar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetX<ChangeAvatarController>(
      init: Get.find<ChangeAvatarController>(),
      initState: (_) {
        Get.find<ChangeAvatarController>().imgPath =
            Get.find<AuthController>().chargerUser.avatar;
      },
      builder: (ctrl) {
        return Center(
          child: Container(
            ...
            decoration: BoxDecoration(
                ...
                image: DecorationImage(
                    fit: BoxFit.fill, image: NetworkImage(ctrl.imgPath))),
          ),
        );
      },
    );
